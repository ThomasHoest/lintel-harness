...
This is the **applied** copy for Lintel Harness — the pack source stays
pristine under `template/specifications/`. Version folders live inside
here (`specifications/v1.0/`); the product brief sits at
`specifications/lintel-harness-brief.md`. Every template, agent prompt,
and convention in the pack assumes this path.
