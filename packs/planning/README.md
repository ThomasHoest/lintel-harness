...
| 3 | Document templates | present | Four — bet brief, roadmap review, portfolio intake, horizon decision aid |
...
| 7 | Folder scaffolding | present | Register, per-bet folders, horizons, decision log, calibration record |
| 7b | Apply recipe | required | `recipe.json` — 14 steps, two of them conditional on the calibration |
...
there: the four document templates, `process.md`, `conventions.md`,
`coordination.md`, the targets README and target template, and **both**
calibrations — including the one this project did not choose.
