...
**Max 220 characters. Never generic. Personal, and a little click-baity is fine. Self-contained** — assume the reader has never seen another post in the series (they may see this one first), so no "as I said in post 1", and say what the post is actually about, not a vague headline like "The game has changed". Everything after the LinkedIn "…see more" fold is read only if the hook lands.

## Beat-by-beat

1. Hook — …
2. …
3. Thesis, stated as a personal conviction — …
4. …
5. Close: an active invitation (follow along / push back), plus a one-line map of what's next when relevant.

## Key facts (verified — for the prose)

*The evidence the prose should rest on — pulled from the corpus close-reads / notes, with the honest caveats attached. Use these; keep the honesty. Never invent figures; mark anything unsourced as a personal observation or [NEEDS SOURCE].*

- …

## Draft

*(The author writes the prose here. The assistant fills Metadata, Hook, Beat-by-beat, and Key facts above, then stops.)*

## Feedback (dated)

*(Feedback goes here, below the post — the draft prose stays untouched; changes get written in by hand. Same loop as the intro post.)*
