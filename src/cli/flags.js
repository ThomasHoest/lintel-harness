 ...
 */
function parse(argv, command, aliases, report) {
    const bag = new DiagnosticBag();
    const flags = {};
    const positionals = [];
    const deferred = [];
    const set = [];
    const accepted = new Set(ACCEPTS[command]);
...
export function parsePass1(argv, command) {
...
export function parsePass2(argv, command, aliases) {
